<template>
  <div class="shelf-search-wrapper" :class="{'search-top': !shelfTitleVisible, 'hide-shadow': ifHideShadow}">
    <div class="shelf-search" :class="{'search-top': !shelfTitleVisible}">
    ...
    <transition name="shelf-tab-slide-up">
      <div class="tab-wrapper" v-if="!shelfTitleVisible">
